...
class WidgetF extends Component {
  ...
  render() {
    ...
    const columns = [
      ...
      },
      {
        ...
        render: (text, record) => (<div>
          ...
          <br/>
          {record.street}, {record.city}, {record.state}, {record.country}, {record.zip}
        </div>)
      },
      {
        ...
        render: (text, record) =>(<span>
          <Button onClick={(e)=>push(`/mall/self/addresses/edit/${record.id}`)} shape="circle" icon="edit" />
    ...
    return (
      <Layout breads={[{href: '/mall/self/addresses', label: 'mall.self.addresses.index.title'}]}>
        <Row>
          <Col>
            <Button onClick={(e)=>push('/mall/self/addresses/new')} type='primary' shape="circle" icon="plus" />
