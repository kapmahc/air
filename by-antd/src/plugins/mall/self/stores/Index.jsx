...
class WidgetF extends Component {
  ...
  render() {
    ...
    return (
      <Layout breads={[{href: '/mall/self/stores', label: 'mall.self.stores.index.title'}]}>
        <Row>
          <Col>
            <Button onClick={(e)=>push('/mall/self/stores/new')} type='primary' shape="circle" icon="plus" />
